...
long_path = "/DataCommon/ksoh/longitudinal/GARD_longitudinal/CN_AD"
long_nc, long_ad = np.load(long_path + "/resized_quan_CN.npy"), np.load(long_path + "/resized_quan_AD.npy")
...
def get_model():
    ...
    # model.load_weights("/home/jsyoon/ks_innvestigate/GARD_brain/component_analysis/AD_NC/1fold_cls_model_102/variables/variables")
    # weight_dict = {}
    ...
    with open("/home/jsyoon/ks_innvestigate/brain/component_analysis/AD_NC/AD_NC_brain_model_weights.pkl", "rb") as f: weight_dict = pickle.load(f)
    new_weight_dict = {}
...
if os.environ["GOOOOG"] == "0":
    ...
    np.save("/DataCommon2/ksoh/lrp_AD.npy", all_res_AD[0])
    np.save("/DataCommon2/ksoh/deeptaylor_AD.npy", all_res_AD[1])
    np.save("/DataCommon2/ksoh/guided_AD.npy", all_res_AD[2])

    np.save("/DataCommon2/ksoh/lrp_NC.npy", all_res_NC[0])
    np.save("/DataCommon2/ksoh/deeptaylor_NC.npy", all_res_NC[1])
    np.save("/DataCommon2/ksoh/guided_NC.npy", all_res_NC[2])